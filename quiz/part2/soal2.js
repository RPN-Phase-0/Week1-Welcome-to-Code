...
console.log('Second Kedua: ' + exampleSecondWord);
console.log('Third Ketiga: ' + exampleThirdWord);
console.log('Fourth Keempat: ' + exampleFourthWord);
console.log('Fifth Kelima: ' + exampleFifthWord);
